...
compo = {
		...
		emp_access_form : ()=>{
			...
			+'    <img src="https://www.w3schools.com/howto/img_avatar2.png" alt="Avatar" class="avatar">'
			+'  </div>'
			+'  <div class="container" id="access_input">'
	/*		+'    <label for="employeeId"><b>EmployeeId</b></label>'
			...
			+'    <input type="text" placeholder="Enter name" name="name" value="김경민" "required">'*/	  
			    ...
			    +'<div class="w3-third">'
			      +'<div class="w3-white w3-text-grey w3-card-4">'
			        ...
			        +'<div class="w3-container">'
			          +'<p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>'+x.customerName+'</p>'
			          +'<p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>'+x.ssn+'</p>'
			          +'<p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>'+x.phone+'</p>'
			          +'<p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>'+x.city+'</p>'
			          +'<p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>'+x.address+'</p>'
			          +'<p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>'+x.postalCode+'</p>'
			          +'<hr>'
		...
		prod_regi :()=>{
            ...
            +'<div class="col-md-5 mb-3">'
              ...
              +'<select id="category_id" class="custom-select d-block w-100" id="country" required="">'
                ...
                +'<option value="labtop">노트북</option>'
            ...
            +'</div>'
	            ...
	            +'<div class="row">'
	              +'<div class="col-md-5 mb-3">'
	                ...
	                +'<select id="supplier_id" class="custom-select d-block w-100" id="country" required="">'
	                  ...
	                  +'<option id="supplierId" value="samsung">삼 성</option>'
	                  +'<option id="supplierId" value="lge">LG전자</option>'
	                  +'<option id="supplierId" value="apple">애 플</option>'
	                  +'<option id="supplierId" value="xiaomi">샤오미</option>'
	                +'</select>'
	              +'</div>'
	            +'</div>'
              ...
              +'</div>'
	            ...
	            +'<div class="d-block my-3">'
	              ...
	              +'  <input id="credit" name="color" value="white" type="radio" class="custom-control-input" checked="" required="">'
	                +'<label class="radi custom-control-label" for="credit">화이트</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="debit" name="color" value="black" type="radio" class="custom-control-input" required="">'
	                +'<label class="radi custom-control-label" for="debit">블랙</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="paypal" name="color" value="blue" type="radio" class="custom-control-input" required="">'
